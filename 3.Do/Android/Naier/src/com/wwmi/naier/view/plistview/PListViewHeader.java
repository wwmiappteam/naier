...
public class PListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.plistview_header, null);
	...
	public void setState(int state) {
		...
		switch (state) {
			case STATE_NORMAL:
				...
				mHintTextView.setText(R.string.plistview_header_hint_normal);
				break;
			case STATE_READY:
				if (mState != STATE_READY) {
					mArrowImageView.clearAnimation();
					mArrowImageView.startAnimation(mRotateUpAnim);
					mHintTextView.setText(R.string.plistview_header_hint_ready);
				}
				break;
			case STATE_REFRESHING:
				mHintTextView.setText(R.string.plistview_header_hint_loading);
				break;
			default:
		}
