package com.wwmi.naier.view.plistview;
...
public class PListView extends ListView implements OnScrollListener {
    ...
    private PListViewListener mListViewListener;
    ...
    // -- footer view
    private PListViewFooter mFooterView;
    ...
    private void initWithContext(Context context) {
        ...
        // init footer view
        mFooterView = new PListViewFooter(context);
    ...
    public void setPullLoadEnable(boolean enable) {
        ...
        if (!mEnablePullLoad) {
            ...
            mPullLoading = false;
            mFooterView.show();
            mFooterView.setState(PListViewFooter.STATE_NORMAL);
    ...
    private void updateFooterHeight(float delta) {
        ...
        if (mEnablePullLoad && !mPullLoading) {
            if (height > PULL_LOAD_MORE_DELTA) { // height enough to invoke load
                                                 // more.
                mFooterView.setState(PListViewFooter.STATE_READY);
            } else {
                mFooterView.setState(PListViewFooter.STATE_NORMAL);
            }
        }
    ...
    private void startLoadMore() {
        ...
        mPullLoading = true;
        mFooterView.setState(PListViewFooter.STATE_LOADING);
    ...
    public void setPListViewListener(PListViewListener l) {
     ...
     */
    public interface OnPScrollListener extends OnScrollListener {
    ...
    public boolean isHeader(View v) {
        ...
        return v == mHeaderView;
    }

    public boolean isFooter(View v) {

        return v == mFooterView;
    }
