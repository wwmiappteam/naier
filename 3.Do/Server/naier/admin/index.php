...
<body id="main_layout" class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:50px;line-height:50px;padding-left:6px;background:url(./images/beijing.png);font-size:20px;color:#0E2D5F;">
		欢迎  <?php echo $_SESSION['admin'];?>  登录奈儿家政后台系统&nbsp;&nbsp;&nbsp;&nbsp;<a style="float:right;color:#0E2D5F;margin-right:20px;font-size:14px;" href="./login.php?action=logout">安全退出</a>
	</div>
	<div data-options="region:'west',split:true,title:'菜单'" style="width:150px;">
		<div id="aa" class="easyui-accordion" data-options="fit:true" >
		    <div title="菜单项目" data-options="selected:true" style="overflow:auto;">
		        <ul class="nav">
		        	<li style="background: rgb(251,236,136);"><a href="javascript:void(0)" onclick="addCentFrm('./active_list.php');"  class="icon-gears">新闻活动</a></li>
		        	...
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./complain_list.php');" class="icon-gears">投诉管理</a></li>
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./advise_list.php');" class="icon-gears">反馈意见</a></li>
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./shop_list.php');"  class="icon-gears">门市管理</a></li>
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./company_edit.php');" class="icon-gears">公司信息</a></li>
				</ul>
		    </div>
		    <div title="家政信息"  style="">
		        <ul class="nav">
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./order_list.php');"  class="icon-gears">顾客预约信息</a></li>
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./custom_list.php');"  class="icon-gears">顾客信息管理</a></li>
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./keeper_info_list.php');"  class="icon-gears">家政人员信息</a></li>
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./keeper_type_edit.php');"  class="icon-gears">家政人员分类</a></li>
		        </ul>
		    </div>
		    ...
		    <div title="系统管理"  style="">
		        <ul class="nav">
		        	<li><a href="javascript:void(0)" onclick="addCentFrm('./admin_list.php');"  class="icon-gears">系统管理员</a></li>
		        </ul>
		    </div>
		</div>
	</div>
	<div data-options="region:'center',title:'首页',tools:'#mainTt'">
		<iframe id="contentFrm" style="border:0px;margin:0px;padding:0px;" frameborder=0 name='welcome' width="100%" height="100%" scrolling="yes" src="./active_list.php"></iframe>
	</div>
	<div id="mainTt">
