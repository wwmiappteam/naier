	    ...
	    <legend>人员信息</legend>
		 <ul class="myform">
	    	...
	    	<hr/>
		 	...
		 	<li class="one"><span class="myinfo">级别：</span><input class="easyui-numberspinner" data-options="min:0,max:6,editable:true,precision:0" value="<?php echo $info['keeper_level']?>" type="text" name="keeper_level"/></li>
