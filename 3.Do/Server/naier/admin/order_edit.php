...
<?php 
	$id = $_REQUEST["id"];
	$sql = "select * from orderinfo_view where orderid=$id";
...
<body nav="顾客预约信息编辑页面" class="iframebody">
	...
	<fieldset id="myfieldset" class="myfieldset">
	    ...
	    <ul class="myform">
		 	...
		 	<li class="one"><span class="myinfo">开始时间：</span><input value="<?php echo $info["start_time"];?>" type="text" name="start_time"/></li>
		 	<li class="one"><span class="myinfo">结束时间：</span><input value="<?php echo $info["end_time"];?>" type="text" name="end_time"/></li>
		 	<li class="one"><span class="myinfo">预约描述：</span><input value="<?php echo $info["order_description"];?>" type="text" name="order_description"/></li>
