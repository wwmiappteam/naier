...
function optFormater(value, rowData, rowIndex) {
	return "<a class='icon icon_edit' title='编辑' href='./service_edit.php?id="+rowData.id+"' ></a>"+
...
<body nav="服务管理页面" class="iframebody">
	 <div class="tools-pannel">
		 <a href="./service_add.php" data-options="iconCls:'icon-add'" class="easyui-linkbutton">添加服务信息</a>
	 </div>
	 <table id="dg" style="" class="easyui-datagrid"
            data-options="rownumbers:true,singleSelect:true,pagination:true,url:'./service_service.php?action=list',method:'get',pageList:[10,20],toolbar:'#tb'">
        <thead>
            <tr>
                <th data-options="field:'serv_title',width:300">服务标题</th>
