...
<body nav="人员信息添加页面" class="iframebody">
	...
	<fieldset id="myfieldset" class="myfieldset">
	    ...
	    <ul class="myform">
		 	...
		 	<li class="one"><span class="myinfo">级别：</span><input type="text" name="keeper_level"/></li>
		 	<li class="one"><span class="myinfo">专业分值：</span><input type="text" name="keeper_professional"/></li>
		 	<li class="one"><span class="myinfo">态度分值：</span><input type="text" name="keeper_attitude"/></li>
		 	<li class="one"><span class="myinfo">勤劳分值：</span><input type="text" name="keeper_hardworking"/></li>
		 	<li class="one"><span class="myinfo">细心分值：</span><input type="text" name="keeper_attentive"/></li>
