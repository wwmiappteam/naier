...
<body nav="活动添加页面" class="iframebody">
	...
	<fieldset id="myfieldset" class="myfieldset">
	    ...
	    <ul class="myform">
		 	...
		 	<li class="three"><textarea name="sendservicinfo" id="sendservicinfo"><?php echo $info["sendservicinfo"];?></textarea></li>
		 	<li class="three1"><span class="myinfo" style="width:105px;">维修服务说明：</span></li>
		 	<li class="three"><textarea name="fixservicinfo" id="fixservicinfo"><?php echo $info["fixservicinfo"];?></textarea></li>
		 	<li class="three1"><span class="myinfo" style="width:105px;">积分兑换规则：</span></li>
		 	<li class="three"><textarea name="pointinfo" id="pointinfo"><?php echo $info["pointinfo"];?></textarea></li>
		 	<li class="button">
